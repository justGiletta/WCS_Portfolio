    ...
    <div class="input-error">
        ...
        <div class="error" id="emailError">
            <?php if (isset($_GET['emailError'])) { 
                echo "<div class=\"error-div\"><i>&#9888;</i> ".$_GET['emailError']."<div class=\"arrow-left\"></div><div class=\"arrow-right\"></div></div>";
            }; ?>
        </div><br><br>
    </div>
    <div class="input-error">
        ...
        <div class="error" id="messageError">
            <?php if (isset($_GET['messageError'])) { 
                 echo "<div class=\"error-div\"><i>&#9888;</i> ".$_GET['messageError']."<div class=\"arrow-left\"></div><div class=\"arrow-right\"></div></div>";
            } ?>
        </div><br>
    </div>
