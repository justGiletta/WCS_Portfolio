if (localStorage.getItem('pinguMode') == 'true') {
    ...
    document.getElementById('facebook-link').setAttribute("href", "https://www.facebook.com/Pingu-62964236562")
    document.getElementById('github-link').setAttribute("href", "https://fr.wikipedia.org/wiki/Pingu")
